...
# --- FUNÇÕES DE PÁGINA: (Definidas no escopo global) ---
...
def edit_rotina_tab(df_rotinas):
    ...
    # Filtra o DataFrame para obter os dados da rotina selecionada
...
def admin_controller(df_rotinas, setor_options):
    ...
    # Se a sessão estiver logada, mostra o admin_view. Se não, mostra o login.
